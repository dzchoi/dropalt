...
/*
    // Jump to bootloader for debugging purposes.
...
void board_init(void)
{
    ...
    // Todo:
    //   - How to know if DFLL is using USB SOF_1KHZ or not?
    //   - Can this preceed usbhub_init() and usb_init()?
    _dfll_usbcrm_init();
}
